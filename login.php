...
<div class="modal fade" id="termsModal" tabindex="-1" role="dialog" aria-labelledby="termsModalLabel" aria-hidden="true">
    ...
    <p>You are responsible for keeping your account and password secure. You accept responsibility for all actions performed through your account.</p>

    <h6>3. Proper Use</h6>
    <p>You agree to use the parish's online services respectfully and lawfully. Prohibited actions include, but are not limited to:</p>
    <ul>
        <li>Disrespectful or abusive behavior toward parish staff or other users</li>
        <li>Submitting false or misleading information</li>
        <li>Attempting unauthorized access to system resources</li>
    </ul>

    <h6>4. Privacy</h6>
    <p>Your personal information will be collected, used, and protected following our Privacy Policy, ensuring confidentiality and responsible data management.</p>

    <h6>5. Content Ownership</h6>
    <p>All materials on this platform, including parish announcements and forms, are protected by intellectual property laws. Unauthorized copying or distribution is prohibited.</p>

    <h6>6. Liability Disclaimer</h6>
    <p>Immaculate Conception Parish is not liable for any direct or indirect damages resulting from service interruptions or unauthorized access to your account.</p>

    <h6>7. Changes to Terms</h6>
    <p>We reserve the right to update these terms as needed. Continued use of the platform after updates signifies acceptance of the revised terms.</p>

    <h6>8. Account Termination</h6>
    <p>We may suspend or terminate accounts at our discretion for violations of these terms or conduct that disrupts our services or community.</p>
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
</div>
