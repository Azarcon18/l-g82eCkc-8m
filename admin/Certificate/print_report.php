...
// Query the database if ID is present
if ($id) {
    $query = "SELECT ar.*, st.sched_type 
              FROM appointment_schedules ar 
              LEFT JOIN schedule_type st ON ar.sched_type_id = st.id 
            ...
            <div class="certificate">
                ...
                <section class="details">
                    ...
                    <p>This is to certify that 
                        <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['death_person_fullname']); ?></span>, 
                        <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['gender']); ?></span> 
                        died on <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['date_of_death']); ?></span>. 
                        Born on <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['birthdate']); ?></span>, 
                        died at <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['resident']); ?></span>. 
                        <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['civil_status']); ?></span>, 
                        resident of <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['resident']); ?></span>, 
                        <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['nationality']); ?></span>. 
                        Child of <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['mother']); ?></span> 
                        and <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['father']); ?></span>.
                    </p>

                    <p>This certification is issued to 
                        <span style="text-decoration:underline;"><?php echo htmlspecialchars($appointment['fullname']); ?></span> 
                        upon their request for whatever legal purpose it may serve.
                    </p>

                    <p>
                        <?php
                        // Set timezone and print current date
                        date_default_timezone_set('Asia/Manila');
                        $current_date = date('F j, Y');
                        echo "Given this $current_date at Immaculate Conception Parish, Poblacion Madridejos Cebu, Burgos St.";
                        ?>
                    </p>
                </section>
    ...
    echo "<h3>Invalid request. No ID provided.</h3>";
}
?>
