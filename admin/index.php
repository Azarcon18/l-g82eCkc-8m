...
// Add .php if not present and ensure it's not a directory
if (!str_ends_with($page, '.php') && !is_dir($page)) {
    $page .= '.php';
}
      ...
      <div class="content-wrapper bg-light pt-3" style="min-height: 567.854px;">
        ...
        <section class="content text-dark">
          <div class="container-fluid">
            <?php 
              // Include the page dynamically
              if (!file_exists($page) && !is_dir($page)) {
                  include '404.html'; // If the file doesn't exist, show 404 page
              } else {
                  if (is_dir($page)) {
                      include $page . '/index.php'; // Include index.php if it's a directory
                  } else {
                      include $page; // Otherwise, include the .php file
                  }
              }
            ?>
          </div>
